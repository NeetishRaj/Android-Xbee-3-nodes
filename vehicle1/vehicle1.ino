 ...
 */
 ...
 /*
      ...
      this modeule will be simulated as a normal Vehicle in the network 
     
      so the RSU must be able to identify it and notify it of the necessary warnings and alerts 
      in Real Time which can be seen on the LCD by the user, moreover ultrasonic sensor will help
